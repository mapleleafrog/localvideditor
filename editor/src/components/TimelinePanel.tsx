...
import { thumbOr } from "../lib/proxies";
...
// Timeline tips draw into a small box — serve the 320 px tier, not the 2048 px one.
const previewUrl = (src: string) => (/^https?:\/\//.test(src) ? src : staticFile(thumbOr(src)));
